...
/* CONFIG DO EDYTACJI */
$mc_host = '51.38.132.58'; // Server host name or IP
$mc_port = 25575;                      // Port rcon is listening on
$mc_password = 'QZ8NFsJCDahPuHTh'; // rcon.password setting set in server.properties
...
class Rcon
{
     ...
     */
    public function __construct($mc_host, $mc_port, $mc_password, $mc_timeout)
    {
        $this->host = $mc_host;
        $this->port = $mc_port;
        $this->password = $mc_password;
        $this->timeout = $mc_timeout;
    }
